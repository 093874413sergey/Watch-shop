...
import { Root, StyledHeader, CentredContent, ImageBlock, Article, StyledLink, ExternalLink } from './Content.styles'

export default function Content() {
  return(
    <Root>
      <CentredContent>
        <StyledHeader>Skeleton watch</StyledHeader>

        <Article>
          <ExternalLink to="/about">
            <img src="https://freepngimg.com/download/rolex/28107-5-rolex-logo-photos.png" alt="#" />
          </ExternalLink>

          <ImageBlock>
            <StyledLink to="/about">Rolex</StyledLink>
            <img src="/pictures/WatchFoto/2.0.jpg"  alt="#" />
          </ImageBlock>
        ...
        <Article>
          <ExternalLink to="/aboutPP">
            <img src="https://cdn.worldvectorlogo.com/logos/patek-philippe-sa-1.svg" alt="#" />
          </ExternalLink>

          <ImageBlock>
            <StyledLink to="/aboutPP">Patek Philippe</StyledLink>
            <img src="https://media.gqmagazine.fr/photos/62694b8f4572c80413a97813/master/w_1600%2Cc_limit/nev1.jpg"  alt="#" />
          </ImageBlock>
