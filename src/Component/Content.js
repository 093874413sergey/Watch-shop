  ...
  return(
    <div className="Content">
      <div className="blok_left">
        <a href="/about-rolex"><img className="Logo_Rolex" src="https://freepngimg.com/download/rolex/28107-5-rolex-logo-photos.png" alt="#" /></a>
        <a href="/about-patek"><img className="Logo_PatekPhilippe" src="https://cdn.worldvectorlogo.com/logos/patek-philippe-sa-1.svg" alt="#" /></a>
      </div>
      <div className="blok_centre">
        <h1>Skeleton watch</h1>
        <div className="text">
          <div className="watch_link">
            <a href="/about-rolex"><span>Rolex</span></a>
          </div>      
        ...
        <div className="text">
          <div className="watch_link">
            <a href="/about-patek"><span>Patek Philippe</span></a>
          </div>
